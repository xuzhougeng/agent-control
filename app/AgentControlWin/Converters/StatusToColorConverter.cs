...
public class StatusToColorConverter : IValueConverter
{
    ...
    private static readonly SolidColorBrush GrayBrush = new(Color.FromArgb(0xFF, 0x8a, 0x90, 0x99));
...
{
    private static readonly SolidColorBrush SuccessBrush = new(Color.FromArgb(0xFF, 0x3a, 0x9e, 0x74));
    private static readonly SolidColorBrush GrayBrush = new(Color.FromArgb(0x99, 0x8a, 0x90, 0x99));
...
{
    private static readonly SolidColorBrush AccentBrush = new(Color.FromArgb(0xFF, 0x31, 0x5f, 0x72));
    private static readonly SolidColorBrush WarningBrush = new(Color.FromArgb(0xFF, 0xc8, 0x75, 0x33));
    private static readonly SolidColorBrush DangerBrush = new(Color.FromArgb(0xFF, 0xd9, 0x4f, 0x4f));
